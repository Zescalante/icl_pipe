...
# # Run the python script. Pass in cluster name, file paths to four coadds and bcg csv, and output and sextractor folder paths.
# python ${script_folder}/icl_measurement.py ${cln} ${refcat} ${coadd_g} ${coadd_r} ${coadd_i} ${coadd_z} ${lsp_mask_g} ${lsp_mask_r} ${lsp_mask_i} ${lsp_mask_z} ${input_bcg_csv} ${output_folder} ${sextractor_folder}
